...
attribute "apache/mod_dir",
  :display_name => "Apache Modules dir",
  :description => "Directory location for modules",
  :default => "mods-available"

attribute "apache/cert_dir",
  :display_name => "Apache certs dir",
  :description => "Directory location for certificates",
  :default => "/etc/ssl/"

attribute "apache/self_cert",
  :display_name => "Self Signed cert",
  :description => "Self Signed certificate file",
  :default => "ssl-cert-snakeoil.pem"

attribute "apache/self_cert_key",
  :display_name => "Self Signed key",
  :description => "Self Signed key file",
